...
config.keys = {
    ...
    { key = 'o', mods = 'CTRL', action = act.SendString('cdi\r') },
    { key = 'u', mods = 'CTRL', action = act.PasteFrom 'Clipboard' },
    { key = 'a', mods = 'CTRL', action = act.SendKey{key='DownArrow', mods=''} },
    { key = 'e', mods = 'CTRL', action = act.SendKey{key='UpArrow', mods=''} },
    ...
    { key = 'h', mods = 'ALT', action = act.SendKey{key='b', mods='CTRL'} },
    { key = "a", mods = "ALT", action = act.ActivateTabRelative(1) },
    { key = "e", mods = "ALT", action = act.ActivateTabRelative(-1) },
    { key = 'i', mods = 'ALT', action = act.SendKey{key='f', mods='CTRL'} },
    { key = 'f', mods = 'ALT', action = act.SendKey{key='a', mods='CTRL'} },
    { key = 'o', mods = 'ALT', action = act.SendKey{key='e', mods='CTRL'} },
    { key = 'd', mods = 'ALT', action = act.SendKey{key='b', mods='ALT'} },
    { key = 'c', mods = 'ALT', action = act.SendKey{key='f', mods='ALT'} },
    { key = 'r', mods = 'ALT', action = act.ActivateCopyMode },
    { key = 't', mods = 'ALT', action = act.SendKey{key='Backspace', mods='ALT'} },
    { key = 's', mods = 'ALT', action = act.SendKey{key='d', mods='ALT'} },
    { key = 'w', mods = 'ALT', action = act.SendKey{key='k', mods='CTRL'} },
}
