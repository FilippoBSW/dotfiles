...
(let ((white     (gdmc 'gruber-material-dark-white))
  ...
  (custom-theme-set-faces
   ...
   `(line-number-current-line ((t (:foreground ,fg0 :background ,bg0))))

   `(whitespace-space ((t (:foreground ,bg1 :background ,bg0))))
   `(whitespace-hspace ((t (:foreground ,bg1 :background ,bg0))))
   `(whitespace-newline ((t (:foreground ,fg0 :background ,bg0))))
   `(whitespace-line ((t (:background ,bg0))))
   `(whitespace-trailing ((t (:foreground ,red :background ,bg0))))
   `(whitespace-indentation ((t (:foreground ,bg1 :background ,bg0))))
   `(whitespace-tab ((t (:foreground ,quartz-1 :background ,bg0))))
   `(whitespace-space-after-tab ((t (:foreground ,quartz-1 :background ,bg0))))
   `(whitespace-space-before-tab ((t (:foreground ,quartz-1 :background ,bg0))))
   ...
   `(corfu-candidate-overlay-face ((t (:foreground ,brown :background ,bg1))))
   `(corfu-candidate-overlay-face-exact-match ((t (:foreground ,brown :background ,bg1 :underline t))))

   `(company-box-annotation ((t (:foreground ,bg0 :background ,bg0))))
   `(company-box-background ((t (:background ,bg0))))
   `(company-box-selection ((t (:foreground ,quartz :background ,bg2))))
   `(company-box-candidate ((t (:foreground ,quartz :background ,bg2))))

   `(company-tooltip-common ((t (:foreground ,quartz))))
   `(company-tooltip-common-selection ((t (:foreground ,quartz))))
   `(company-box-annotation ((t (:foreground ,bg0 :background ,bg0))))
   `(company-box-annotation-selection ((t (:foreground ,bg2 :background ,bg2))))
   ...
   `(magit-diff-file-heading-selection ((t (:foreground ,quartz :background ,bg0))))
