...
(deftheme gruber-material-dark
  "gruber darker material")

(defconst gruber-material-dark-colors
  '((gruber-material-dark-white     . "#ffffff")
    (gruber-material-dark-black     . "#000000")
    (gruber-material-dark-fg0       . "#e4e4ef")
    ...
    (gruber-material-dark-green     . "#81b29a")
    (gruber-material-dark-bg-yellow . "#463e2a")
    (gruber-material-dark-yellow    . "#d2b55b")
    (gruber-material-dark-brown     . "#7c6f64")
    (gruber-material-dark-bg-quartz . "#353a39")
    (gruber-material-dark-quartz-1  . "#6b7570")
    (gruber-material-dark-quartz    . "#95a99f")
...
(defun gdmc (color-name)
  (cdr (assoc color-name gruber-material-dark-colors)))

(defface mode-line-buffer-id-inactive
  `((t (:inherit mode-line-buffer-id :foreground ,(gdmc 'gruber-material-dark-quartz-1) :background ,(gdmc 'gruber-material-dark-bg0))))
  "Face for buffer name in inactive windows.")

(let ((white     (gdmc 'gruber-material-dark-white))
      (black     (gdmc 'gruber-material-dark-black))
      (fg0       (gdmc 'gruber-material-dark-fg0))
      (bg0       (gdmc 'gruber-material-dark-bg0))
      (bg1       (gdmc 'gruber-material-dark-bg1))
      (bg2       (gdmc 'gruber-material-dark-bg2))
      (bg3       (gdmc 'gruber-material-dark-bg3))
      (bg4       (gdmc 'gruber-material-dark-bg4))
      (bg-red    (gdmc 'gruber-material-dark-bg-red))
      (red       (gdmc 'gruber-material-dark-red))
      (bg-green  (gdmc 'gruber-material-dark-bg-green))
      (green     (gdmc 'gruber-material-dark-green))
      (bg-yellow (gdmc 'gruber-material-dark-bg-yellow))
      (yellow    (gdmc 'gruber-material-dark-yellow))
      (brown     (gdmc 'gruber-material-dark-brown))
      (bg-quartz (gdmc 'gruber-material-dark-bg-quartz))
      (quartz-1  (gdmc 'gruber-material-dark-quartz-1))
      (quartz    (gdmc 'gruber-material-dark-quartz))
      (niagara0  (gdmc 'gruber-material-dark-niagara0))
      (niagara1  (gdmc 'gruber-material-dark-niagara1))
      (niagara2  (gdmc 'gruber-material-dark-niagara2))
      (wisteria  (gdmc 'gruber-material-dark-wisteria)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:foreground ,wisteria :background ,fg0))))
   ...
   `(help-key-binding ((t (:foreground ,quartz))))
   `(bookmark-face ((t (:foreground ,quartz))))
   `(escape-glyph ((t (:foreground ,quartz))))
   `(homoglyph ((t (:foreground ,quartz))))
   `(success ((t (:foreground ,quartz))))
   `(warning ((t (:foreground ,wisteria))))
   ...
   `(whitespace-indentation ((t (:foreground ,wisteria :background ,bg0))))
   `(whitespace-tab ((t (:foreground ,wisteria :background ,bg0))))
   `(whitespace-space-after-tab ((t (:foreground ,wisteria :background ,bg0))))
   `(whitespace-space-before-tab ((t (:foreground ,wisteria :background ,bg0))))
   `(whitespace-missing-newline-at-eof ((t (:foreground ,bg1 :background ,bg0))))
   `(whitespace-empty ((t (:foreground ,red :background ,bg0))))
   ...
   `(mode-line-buffer-id ((t (:foreground ,quartz :background ,bg1))))
   `(mode-line ((t (:foreground ,fg0 :background ,bg1 :box (:line-width 1 :color ,niagara1 :style nil)))))
   `(mode-line-active ((t (:foreground ,fg0 :background ,bg1 :box (:line-width 1 :color ,niagara1 :style nil)))))
   ...
   `(isearch ((t (:foreground ,fg0 :background ,quartz-1))))
   ...
   `(font-lock-builtin-face ((t (:foreground ,wisteria))))
   ...
   `(font-lock-keyword-face ((t (:foreground ,wisteria))))
   ...
   `(font-lock-regexp-face ((t (:foreground ,quartz))))
   `(font-lock-regexp-grouping-backslash ((t (:foreground ,wisteria))))
   `(font-lock-regexp-grouping-construct ((t (:foreground ,wisteria))))
   `(font-lock-string-face ((t (:foreground ,green))))
   `(font-lock-type-face ((t (:foreground ,quartz))))
   ...
   `(sh-quoted-exec ((t (:foreground ,quartz))))

   `(completions-highlight ((t (:background ,bg2))))
   `(completions-common-part ((t (:foreground ,wisteria))))
   `(completions-annotations ((t (:foreground ,quartz :background ,bg0))))
   `(completions-group-title ((t (:foreground ,quartz :background ,bg0))))
   `(completions-group-separator ((t (:foreground ,quartz :background ,bg0))))

   `(corfu-default ((t (:foreground ,fg0 :background ,bg1))))
   `(corfu-current ((t (:foreground ,fg0 :background ,bg2))))
   `(corfu-bar ((t (:background ,bg2))))
   `(corfu-border ((t (:background ,bg1))))
   `(corfu-annotations ((t (:foreground ,fg0 :background ,bg1))))
   `(corfu-deprecated ((t (:foreground ,fg0 :strike-through t))))

   `(ido-first-match ((t (:foreground ,quartz))))
   `(ido-only-match ((t (:foreground ,quartz))))
   ...
   `(vertico-group-title ((t (:foreground ,quartz :inherit bold))))
   `(vertico-group-separator ((t (:foreground ,quartz :strike-through ,quartz))))

   `(vertico-posframe ((t (:foreground ,fg0 :background ,bg1))))
   `(vertico-posframe-border ((t (:background ,quartz))))

   `(orderless-match-face-0 ((t (:foreground ,fg0 :background ,bg2))))
   `(orderless-match-face-1 ((t (:foreground ,fg0 :background ,bg2))))
   `(orderless-match-face-2 ((t (:foreground ,fg0 :background ,bg2))))
   `(orderless-match-face-3 ((t (:foreground ,fg0 :background ,bg2))))

   `(compilation-info ((t (:foreground ,quartz))))
   `(compilation-line-number ((t (:foreground ,quartz))))
   `(compilation-column-number ((t (:foreground ,quartz))))
   `(compilation-mode-line-exit ((t (:foreground ,quartz))))
   ...
   `(consult-preview-match ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-file ((t (:foreground ,quartz))))
   `(consult-highlight-mark ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-highlight-match ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-preview-insertion ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-preview-line ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-key ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-help ((t (:foreground ,fg0 :background ,bg2))))
   `(consult-grep-context ((t (:foreground ,quartz :background ,bg2))))
   `(consult-line-number ((t (:foreground ,quartz :background ,bg0))))
   `(consult-line-number-prefix ((t (:foreground ,quartz :background ,bg0))))
   `(consult-line-number-wrapped ((t (:foreground ,quartz :background ,bg0))))
   ...
   `(vr/match-0 ((t (:foreground ,bg0 :background ,quartz))))
   `(vr/match-1 ((t (:foreground ,bg0 :background ,quartz)))
                )
   `(vr/match-separator-face ((t (:foreground ,bg0 :background ,red))))

   `(avy-background-face ((t (:background ,bg0))))
   `(avy-lead-face ((t (:foreground ,quartz :background ,bg0))))
   `(avy-lead-face-0 ((t (:foreground ,wisteria :background ,bg0))))
   `(avy-lead-face-1 ((t (:foreground ,green :background ,bg0))))
   `(avy-lead-face-2 ((t (:foreground ,niagara2, :background ,bg0))))

   `(dired-broken-symlink ((t (:foreground ,red :background ,bg0))))
   `(dired-directory ((t (:foreground ,quartz :background ,bg0))))
   ...
   `(dired-mark ((t (:foreground ,quartz :background ,bg0))))
   ...
   `(diredfl-dir-name ((t (:foreground ,quartz))))
   ...
   `(org-level-1 ((t (:foreground ,quartz :height 1.1))))
   ...
   `(org-level-5 ((t (:foreground ,quartz :height 1.0))))
   ...
   `(org-link ((t (:foreground ,quartz :underline ,quartz))))
   ...
   `(org-ellipsis ((t (:foreground ,quartz))))
   `(org-date ((t (:foreground ,quartz :underline t))))
   `(org-sexp-date ((t (:foreground ,quartz :underline t))))
   `(org-tag ((t (:weight bold))))
   `(org-list-dt ((t (:weight bold))))
   `(org-agenda-done ((t (:foreground ,niagara2))))
   `(org-headline-done ((t (:foreground ,niagara2))))
   `(org-table ((t (:foreground ,quartz))))
   ...
   `(markdown-header-face-5 ((t (:foreground ,quartz))))
   `(markdown-header-face-6 ((t (:foreground ,niagara2))))

   `(git-commit-summary ((t (:foreground ,fg0))))
   `(git-commit-overlong-summary ((t (:foreground ,quartz))))
   `(git-commit-nonempty-second-line ((t (:foreground ,red))))

   `(magit-header-line ((t (:foreground ,wisteria))))
   `(magit-section-heading ((t (:foreground ,wisteria))))
   ...
   `(magit-log-date ((t (:foreground ,quartz))))
   ...
   `(magit-reflog-other ((t (:foreground ,quartz))))
   ...
   `(magit-sequence-head ((t (:foreground ,quartz))))
   ...
   `(magit-cherry-unmatched ((t (:foreground ,quartz))))
   ...
   `(ediff-current-diff-Ancestor ((t (:background ,bg-quartz))))
   `(ediff-current-diff-A ((t (:background ,bg-green))))
   `(ediff-current-diff-B ((t (:background ,bg-red))))
   `(ediff-current-diff-C ((t (:background ,bg-yellow))))
   `(ediff-even-diff-Ancestor ((t (:background ,bg-quartz))))
   `(ediff-even-diff-A ((t (:background ,bg-green))))
   `(ediff-even-diff-B ((t (:background ,bg-red))))
   `(ediff-even-diff-C ((t (:background ,bg-yellow))))
   `(ediff-fine-diff-Ancestor ((t (:background ,bg-quartz))))
   `(ediff-fine-diff-A ((t (:background ,bg-green))))
   `(ediff-fine-diff-B ((t (:background ,bg-red))))
   `(ediff-fine-diff-C ((t (:background ,bg-yellow))))
   `(ediff-odd-diff-Ancestor ((t (:background ,bg-quartz))))
   `(ediff-odd-diff-A ((t (:background ,bg-green))))
   `(ediff-odd-diff-B ((t (:background ,bg-red))))
   `(ediff-odd-diff-C ((t (:background ,bg-yellow))))

   `(smerge-base ((t (:background ,bg2))))
   `(smerge-lower ((t (:background ,bg2))))
   `(smerge-upper ((t (:background ,bg2))))
   `(smerge-refined-removed ((t (:foreground ,fg0 :background ,bg-green))))
   `(smerge-refined-changed ((t (:foreground ,fg0 :background ,bg-green))))
   `(smerge-refined-added ((t (:foreground ,fg0 :background ,bg-red))))
   ...
   `(persp-selected-face ((t (:foreground ,quartz))))
   `(eglot-mode-line ((t (:foreground ,quartz :weight medium))))
   `(marginalia-documentation ((t (:foreground ,fg0 :italic t))))

   `(eshell-prompt ((t (:foreground ,quartz))))
   ...
   `(ansi-color-bright-wisteria ((t (:foreground ,wisteria :background ,wisteria))))
   ...
   `(ansi-color-bright-cyan ((t (:foreground ,quartz :background ,quartz))))
   `(ansi-color-bright-white ((t (:foreground ,fg0 :background ,fg0))))

   `(transient-heading ((t (:foreground ,fg0))))
   `(transient-key ((t (:foreground ,quartz))))
   `(transient-key-stack ((t (:foreground ,quartz))))
   ...
   `(transient-argument ((t (:foreground ,quartz))))
   `(transient-value ((t (:foreground ,quartz))))
   ...
   `(transient-enabled-suffix ((t (:foreground ,quartz))))
   `(transient-disabled-suffix ((t (:foreground ,bg4))))
   `(transient-separator ((t (:foreground ,bg4))))
   `(transient-pink ((t (:foreground ,wisteria))))
   `(transient-blue ((t (:foreground ,niagara2))))
   `(transient-red ((t (:foreground ,red))))
   `(transient-quartz ((t (:foreground ,quartz))))
   `(transient-wisteria ((t (:foreground ,wisteria))))
   `(transient-orange ((t (:foreground ,wisteria))))
   `(transient-aqua ((t (:foreground ,quartz))))))
...
(provide-theme 'gruber-material-dark)
