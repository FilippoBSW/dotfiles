...
;;; Theme
(load-theme 'gruvbox-material-medium :no-confirm)
...
(defun my-tmux-to-emacs-buffer ()
  (interactive)
  (let ((content (shell-command-to-string "tmux capture-pane -p")))
...
(defun my-tmux-to-emacs-buffer-all ()
  (interactive)
  (let ((content (shell-command-to-string "tmux capture-pane -p -S -")))
...
(add-to-list 'auto-mode-alist '("CMakeLists\\.txt\\'" . (lambda() (cmake-mode))))
(add-to-list 'auto-mode-alist '("\\.cmake\\'" . (lambda() (cmake-mode))))
...
(add-keymap my-find-keymap #'my-consult-fd-directories "a" "my-consult-fd-directories")
...
(add-keymap my-magit-keymap #'vc-diff "7" "vc-diff")
(add-keymap my-magit-keymap #'vc-ediff "8" "vc-ediff")
(add-keymap my-magit-keymap #'vc-dir "9" "vc-dir")
...
(add-keymap my-window-keymap #'windower-swap "w" "windower-swap") ;; TODO: maybe use window rotate in Emacs 31
