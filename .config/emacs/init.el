...
(setq buffer-default-sorting-mode 'filename/process
      ...
      magit-delta-default-dark-theme "gruvbox-material-dark"
...
(with-eval-after-load 'smerge-mode
  (keymap-set smerge-mode-map "C-a" #'smerge-next)
  (keymap-set smerge-mode-map "C-e" #'smerge-prev)
...
(defun my--set-faces ()
  ...
  (let ((faces `((default :background ,(my--gmc 'bg0))
                 ...
                 (ediff-current-diff-A :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (ediff-current-diff-Ancestor :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-blue))
                 (ediff-current-diff-B :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-green))
                 (ediff-current-diff-C :foreground ,(my--gmc 'fg2)  :background ,(my--gmc 'bg-visual-yellow))
                 (ediff-even-diff-A :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (ediff-even-diff-Ancestor :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-blue))
                 (ediff-even-diff-B :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-green))
                 (ediff-even-diff-C :foreground ,(my--gmc 'fg2)  :background ,(my--gmc 'bg-visual-yellow))
                 (ediff-fine-diff-A :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (ediff-fine-diff-Ancestor :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-blue))
                 (ediff-fine-diff-B :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-green))
                 (ediff-fine-diff-C :foreground ,(my--gmc 'fg2)  :background ,(my--gmc 'bg-visual-yellow))
                 (ediff-odd-diff-A :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (ediff-odd-diff-Ancestor :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-blue))
                 (ediff-odd-diff-B :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-green))
                 (ediff-odd-diff-C :foreground ,(my--gmc 'fg2)  :background ,(my--gmc 'bg-visual-yellow))
                 (diff-refine-added   :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-green))
                 (diff-refine-changed :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (diff-refine-removed :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (smerge-base :background ,(my--gmc 'bg-visual-blue))
                 (smerge-lower :background ,(my--gmc 'bg-visual-green))
                 (smerge-upper :background ,(my--gmc 'bg-visual-red))
                 (smerge-refined-removed :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (smerge-refined-changed :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-red))
                 (smerge-refined-added   :foreground ,(my--gmc 'fg2) :background ,(my--gmc 'bg-visual-green))
                 (org-link :foreground ,(my--gmc 'green))
