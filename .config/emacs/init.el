...
;;; Font
(setq
 my--font-name (if (eq system-type 'windows-nt)
                   "JetBrainsMono NFM Medium"
                 "JetBrainsMono Nerd Font Mono")
 my--font-size 8
 my--font-weight "semibold"
 my--font-spec (format "%s-%s:%s" my--font-name my--font-size my--font-weight))
...
(require!
 my-consult-buffer-fix
 my-kind-icon-mapping
 my-modeline)
...
(defconst!
 (my--fd-executable-path  "~/.cargo/bin/fd")
...
(defvar!
 ...
 (my--corfu-auto-mode-line-string ""))

(consult-customize
 consult--source-buffer :name "λ" :hidden t :narrow ?\l
...
;;; Keybindings
(bind! global-map ("C-x a" my-normal-map "normal map"))
...
(meow-normal-define-key
 ...
 '("k" . meow-line)
 '("p" . mark-word)
 (cons "." (=> (backward-paragraph)))
 (cons "," (=> (forward-paragraph)))
 '("/" . mark-paragraph)
...
(bind! my-search-keymap
       ...
       ("u" #'avy-goto-char-timer "avy-goto-char-timer")
...
(bind! global-map
       ...
       ("C-S-s" #'vr/isearch-forward "vr/isearch-forward")
       ("C-S-r" #'vr/isearch-backward "vr/isearch-backward")
       ...
       ("C-c u" #'vundo "vundo")
       ("C-c h" #'help-command "help-command")
...
(bind! magit-mode-map
       ...
       ("q" (=> (magit-kill-this-buffer) (delete-window)) "magit-kill-this-buffer")
...
(bind! dired-mode-map
       ...
       ("i" #'dired-find-alternate-file "dired-find-alternate-file")
...
(bind! vertico-multiform-map
       ...
       ("C-S-a" #'vertico-next-group "vertico-next-group")
       ("C-S-e" #'vertico-previous-group "vertico-previous-group")
