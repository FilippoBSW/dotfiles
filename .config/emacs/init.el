...
(with-eval-after-load 'company
  (my--rename-mode 'company-mode " cmp"))

(with-eval-after-load 'company-box
  (my--rename-mode 'company-box-mode ""))
...
(add-keymaps my-toggle-keymap
             ...
             ("c" #'my-toggle-company "c" "my-toggle-company")
...
(add-keymaps my-buffer-keymap
             ...
             ("b" #'kill-matching-buffers-no-ask "b" "kill-matching-buffers-no-ask")
...
(add-keymaps my-persp-keymap
             ...
             ("x" (=> (persp-forget-buffer (buffer-name)) (delete-window)) "x" "persp-forget-buffer")
