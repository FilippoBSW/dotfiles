...
(add-keymap my-magit-keymap #'magit-git-command-topdir "," "magit-git-command-topdir")
...
(add-keymap my-window-keymap #'delete-frame "C" "delete-frame")
(add-keymap my-window-keymap #'delete-other-windows-vertically "b" "delete-side-and-vertical")
...
(add-keymap my-window-keymap #'window-toggle-side-windows "m" "window-toggle-side-windows")
...
(add-keymap my-toggle-keymap #'my-toggle-vc-mode "l" "my-toggle-vc-mode")
(add-keymap my-toggle-keymap #'flymake-show-buffer-diagnostics "d" "flymake-show-buffer-diagnostics")
(add-keymap my-toggle-keymap #'my-toggle-corfu-auto "c" "my-toggle-corfu-auto")
(add-keymap my-toggle-keymap #'my-toggle-eglot-flymake "r" "my-toggle-eglot-flymake")
(add-keymap my-toggle-keymap #'my-toggle-eglot-global "t" "my-toggle-eglot-global")
(add-keymap my-toggle-keymap #'my-toggle-eglot-format-on-save "s" "my-toggle-eglot-format-on-save")
(add-keymap my-normal-map my-toggle-keymap "u" "my-toggle-keymap")
...
(add-keymap my-normal-map #'switch-to-buffer-other-frame "C" "switch-to-buffer-other-frame")
...
(keymap-set global-map "C-v" #'my-toggle-vertico-flat-mode)
...
(keymap-set flymake-diagnostics-buffer-mode-map "<backspace>" (lambda () (interactive) (call-interactively #'flymake-goto-diagnostic) (select-window (old-selected-window))))
