...
(add-hook 'ediff-startup-hook (lambda ()
                                ...
                                (keymap-set ediff-mode-map "8" #'ediff-copy-A-to-B)
                                (keymap-set ediff-mode-map "9" #'ediff-copy-A-to-C)
                                (keymap-set ediff-mode-map "f" #'ediff-copy-B-to-A)
                                (keymap-set ediff-mode-map "u" #'ediff-copy-B-to-C)
                                (keymap-set ediff-mode-map "h" #'ediff-copy-C-to-A)
                                (keymap-set ediff-mode-map "a" #'ediff-copy-C-to-B)))
...
(add-keymap my-buffer-keymap #'persp-ibuffer "h" "ibuffer")
...
(keymap-set magit-blame-read-only-mode-map "," (lambda () (interactive) (magit-blame-next-chunk) (recenter)))
(keymap-set magit-blame-read-only-mode-map "." (lambda () (interactive) (magit-blame-previous-chunk) (recenter)))
...
(keymap-set magit-stash-mode-map "," (lambda () (interactive) (magit-section-forward) (recenter)))
(keymap-set magit-stash-mode-map "." (lambda () (interactive) (magit-section-backward) (recenter)))
...
(keymap-set magit-revision-mode-map "," (lambda () (interactive) (magit-section-forward) (recenter)))
(keymap-set magit-revision-mode-map "." (lambda () (interactive) (magit-section-backward) (recenter)))
...
(keymap-set magit-status-mode-map "," (lambda () (interactive) (magit-section-forward) (recenter)))
(keymap-set magit-status-mode-map "." (lambda () (interactive) (magit-section-backward) (recenter)))
