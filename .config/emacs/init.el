...
(defun my-magit-restore-current ()
  ...
  (let ((path (my-copy-full-path)))
    (magit-git-command-topdir (format "git restore %s" (shell-quote-argument path)))))
...
(add-keymaps my-find-keymap
             ("f" (=> (my--call-with-vertico 'my--consult-fd-with-region default-directory)) "consult-fd-1")
             ("o" (=> (my-consult-fd-directories default-directory)) "my-consult-fd-directories-1")
             ("h" (=> (my--call-with-vertico 'my--consult-fd-with-region (my--get-project-dir))) "consult-fd")
...
(add-keymaps my-search-keymap
             ("f" (=> (my--call-with-vertico 'my--consult-ripgrep-with-region default-directory)) "consult-ripgrep-1")
             ("o" (=> (my--call-with-vertico 'consult-imenu)) "consult-imenu")
             ("h" (=> (my--call-with-vertico 'my--consult-ripgrep-with-region (my--get-project-dir))) "consult-ripgrep")
             ("a" (=> (my--call-with-vertico 'my--consult-line-with-region)) "consult-line"))
...
(define-keys corfu-mode-map
             ("C-h" #'corfu-info-documentation)
             ("C-SPC" #'corfu-insert-separator)
             ("C-o" (=> (my--call-with-vertico 'my-corfu-move-to-minibuffer)))
             ("C-SPC" #'corfu-insert-separator))
