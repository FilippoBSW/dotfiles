...
(defun my--set-faces ()
  ...
  (let ((faces `((compilation-info :foreground ,(my--gmc 'bg-visual-blue))
                 ...
                 (vr/group-1 :background ,(my--gmc 'green) :foreground ,(my--gmc 'fg0))
                 (vr/group-2 :background ,(my--gmc 'yellow) :foreground ,(my--gmc 'fg0))
                 ...
                 (whitespace-line :foreground ,(my--gmc 'red))
